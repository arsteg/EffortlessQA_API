...
namespace EffortlessQA.Data.Migrations
{
    ...
    [Migration("20250616042713_addedreferenceOfReToTestSuite")]
    partial class addedreferenceOfReToTestSuite
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EffortlessQA.Data.Entities.RequirementTestSuite", b =>
                {
                    ...
                    b.ToTable("RequirementTestSuite");
                });
            ...
            modelBuilder.Entity("EffortlessQA.Data.Entities.TestCase", b =>
                {
                    ...
                    b.Property<JsonDocument>("ExpectedResults")
                        .HasColumnType("jsonb");
