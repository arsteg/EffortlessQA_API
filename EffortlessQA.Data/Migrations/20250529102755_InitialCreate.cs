    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantEmailConfirmations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    BillingContactEmail = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestFolders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TestFolders_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ParentSuiteId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Line3 = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Steps = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                    ExpectedResults = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestCases_TestFolders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "TestFolders",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    AssignedTesterId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestRuns_Users_AssignedTesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestRunResultId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Defects_TestRunResults_TestRunResultId",
                        column: x => x.TestRunResultId,
                        principalTable: "TestRunResults",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Defects_Users_AssignedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DefectHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DefectHistories_TenantId_DefectId_CreatedAt",
                table: "DefectHistories",
                columns: new[] { "TenantId", "DefectId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_DefectHistories_UserId",
                table: "DefectHistories",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Defects_AssignedUserId",
                table: "Defects",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Defects_TenantId_Status_Severity",
                table: "Defects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Defects_TestRunResultId",
                table: "Defects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requirements_TenantId_ProjectId",
                table: "Requirements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestCases_TenantId_TestSuiteId_Priority",
                table: "TestCases",
                columns: new[] { "TenantId", "TestSuiteId", "Priority" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestFolders_ProjectId",
                table: "TestFolders",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TestRunResults_TenantId_TestRunId_Status",
                table: "TestRunResults",
                columns: new[] { "TenantId", "TestRunId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestRuns_AssignedTesterId",
                table: "TestRuns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestRuns_TenantId_ProjectId",
                table: "TestRuns",
                columns: new[] { "TenantId", "ProjectId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestSuites_TenantId_ProjectId",
                table: "TestSuites",
                columns: new[] { "TenantId", "ProjectId" });
